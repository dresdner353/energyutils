...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file EI/ei_report_dualboost.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file EI/ei_report_sat_free.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file EI/ei_report_sun_free.xlsx \
    --tariff_rate Day:0.4346 Night:0.4346 Free:0 \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file BGE/bge_report_standard_smart.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file BGE/bge_report_discount_weekend.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file BGE/bge_report_freetime_sat.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file BGE/bge_report_freetime_sun.xlsx \
    --tariff_rate Day:0.5094 Night:0.3743 Peak:0.6223  Free:0 \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file SSE/sse_report_boost.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file ENERGIA/energia_report_smart.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file ENERGIA/energia_report_ev.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file FLOGAS/flogas_report_smart.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file PINERGY/pinergy_report_work_from_home.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file PINERGY/pinergy_report_family_time.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file PINERGY/pinergy_report_ev.xlsx \
...
python3 ${GEN_REPORT_SCRIPT} \
    --idir ${HDF_DATA} \
    --file PINERGY/pinergy_report_standard_smart.xlsx \
