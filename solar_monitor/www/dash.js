...
function set_layout() {
    ...
    small_layout = `
                <div id="master" class="container-fluid align-middle" data-bs-theme="dark">
                    <div class="row align-middle">
                        <div id="donut_a_insert" class="col col-5 mt-2 align-middle">
                        </div>
                        <div id="metrics_a_insert" class="col col-7 mt-2 align-middle">
                        </div>
                    </div>
                </div>
            `;
...
function render_charts() {
    ...
    switch(layout) {
      case "small":
      donut_chart_height = (window.innerHeight) * 0.6;
